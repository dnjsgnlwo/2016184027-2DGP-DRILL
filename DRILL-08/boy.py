...
class RunState:
    ...
    def do(boy):
        boy.frame = (boy.frame + 1) % 8
        boy.timer -= 1
        if boy.isDash and boy.dTimer < 200:
...
next_state_table = {
    IdleState:
        {RIGHT_UP: RunState, LEFT_UP: RunState, RIGHT_DOWN: RunState,
         LEFT_DOWN: RunState, LSHIFT_DOWN: IdleState, LSHIFT_UP: IdleState},
    RunState:
        {RIGHT_UP: IdleState, LEFT_UP: IdleState, LEFT_DOWN: IdleState,
